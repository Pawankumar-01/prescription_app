      ...
      <div className="page a4">
        ...
        <div className="lower-grid">
          ...
          <div className="bullets">
            ...
            “Save trees, save the future and write off paper — go electronic.”
            <br />
            <span>Think before printing.</span>
          </div>
